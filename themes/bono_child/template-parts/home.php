...
<main class="main">
        ...
        <ul class="tabs__content">
          ...
          <li class="tabs__item" id="tab-1">
            <ul class="tabs__sub-list tabs__sub-list--mod">
              <li class="product-promo"><a class="product-promo__link"
                  href="https://fsapsan.ru/sorting-product-item/selskoe-hozyaystvo/melkosemyannye-i-maslichnye-kultury/">
          ...
          <li class="tabs__item" id="tab-3">
            <ul class="tabs__sub-list tabs__sub-list--two">
              ...
              <li class="product-promo"><a class="product-promo__link"
                  href="https://fsapsan.ru/sorting-product-item/nepischevoe-syryo/metallicheskie-fraktsii/">
              ...
              <li class="product-promo"><a class="product-promo__link"
                  href="https://fsapsan.ru/sorting-product-item/nepischevoe-syryo/farmatsevticheskoe-syryo/">
  ...
  <section class="choose-us">
    <div class="wrapper">
      ...
      <br>
      <p>Компания по производству линий сортировки Смарт Грэйд - это лидер в области разработки и изготовления высокотехнологичного оборудования для сортировки различных материалов. Наша компания предлагает широкий ассортимент сортировочных линий, которые отвечают самым высоким требованиям качества, эффективности и экологичности.</p>
      <p>Мы - один из крупнейших производителей сортировочного оборудования. Наше оборудование используется для сортировки продуктов сельского хозяйства, пищевой промышленности и непищевого сырья.</p>
      <p>Наша компания предоставляет полный спектр услуг по проектированию, монтажу, наладке, обслуживанию и ремонту сортировочного оборудования. Мы оказываем консультационную поддержку на всех этапах сотрудничества с нашими клиентами. Мы гарантируем высокое качество нашего оборудования и его долговечность.
</p>
    </div>
  </section>
