...
<div <?php wc_product_class( "shop-item shop-item--type-{$card_type}{$fix_add_to_cart} " . $availability['class'], $product ) ?>>
    ...
    <div class="<?php echo esc_attr( apply_filters( 'bono_shop_item_inner_classes', 'shop-item-inner', '' ) ) ?>">

        <div class="shop-item__image">
            <div class="<?php echo esc_attr( apply_filters( 'bono_shop_item_image_inner_classes', 'shop-item__image-inner', '' ) ) ?>">

                <?php do_action( 'bono_product_thumbnail', '' ); ?>

                <?php if ( $product->is_in_stock() ): ?>
                    <div class="shop-item__buttons">

                        <?php do_action( 'bono_shop_item_buttons', '' ); ?>
        ...
        <div class="shop-item__badges">
            <?php do_action( 'bono_shop_item_badges', '' ); ?>
        </div>
