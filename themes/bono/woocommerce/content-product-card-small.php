...
<div <?php wc_product_class( 'shop-item shop-item--type-small ' . $availability['class'], $product ) ?>>
    ...
    <div class="<?php echo esc_attr( apply_filters( 'bono_shop_item_inner_classes', 'shop-item-inner', 'card-small' ) ) ?>">

        <div class="shop-item__image">
            <div class="<?php echo esc_attr( apply_filters( 'bono_shop_item_image_inner_classes', 'shop-item__image-inner', 'card-small' ) ) ?>">

                <?php do_action( 'bono_product_thumbnail', 'card-small' ); ?>

                <?php if ( $product->is_in_stock() ): ?>
                    <div class="shop-item__buttons">
                        <?php do_action( 'bono_shop_item_buttons', 'card-small' ); ?>
        ...
        <div class="shop-item__body">
            <div class="shop-item__badges">
                <?php do_action( 'bono_shop_item_badges', 'card-small' ); ?>
            </div>
